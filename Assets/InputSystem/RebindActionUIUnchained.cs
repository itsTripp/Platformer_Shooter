...
////TODO: deal with composites that have parts bound in different control schemes
    ...
    /// </summary>
    public class RebindActionUIUnchained : MonoBehaviour
    {
        /// <summary>
        ...
        protected void OnEnable()
        {
            if (s_RebindActionUIs == null)
                s_RebindActionUIs = new List<RebindActionUIUnchained>();
        ...
        private static List<RebindActionUIUnchained> s_RebindActionUIs;
        ...
        [Serializable]
        public class UpdateBindingUIEvent : UnityEvent<RebindActionUIUnchained, string, string, string>
        {
        }

        [Serializable]
        public class InteractiveRebindEvent : UnityEvent<RebindActionUIUnchained, InputActionRebindingExtensions.RebindingOperation>
        {
        }
    }
